  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <p className="text-zinc-600 dark:text-zinc-400 mb-12 text-lg">
        Apps and tools I&apos;ve built or am actively developing. A mix of fitness,
        productivity, and developer utilities.
      </p>
      ...
      <ul className="space-y-10">
        {projects.map((project) => (
          <li
            key={project.id}
            className="group border-b border-zinc-200 dark:border-zinc-800 pb-10 last:border-0"
          >
            <div className="flex items-baseline justify-between gap-4">
              <h2 className="text-xl font-medium text-zinc-900 dark:text-zinc-100 group-hover:text-zinc-600 dark:group-hover:text-zinc-300 transition-colors">
                {project.name}
              </h2>
              {project.status && (
                <span

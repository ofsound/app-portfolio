...
export default function About() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-12">
      ...
      <div className="max-w-none space-y-6 text-zinc-600 dark:text-zinc-400 leading-relaxed">
        ...
        <p>This portfolio is a snapshot of what I&apos;ve been working on lately—some projects are live, others are in progress, and a few have been retired. Feel free to reach out if you&apos;d like to connect or collaborate.</p>
      </div>
    </div>
  );
}

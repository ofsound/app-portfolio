...
export default function About() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-12">
      <h1 className="mb-8 text-3xl font-semibold tracking-tight text-text">About</h1>

      <div className="max-w-none leading-relaxed text-text-secondary">
        ...
        <p className="mt-6">
          This portfolio is a snapshot of what I&apos;ve been working on lately—some
          projects are live, others are in progress, and a few have been retired.
